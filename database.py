...
class Prediction(Base):
    ...
    t1_home_form_gs = Column(Integer, nullable=True)
    t1_home_form_gc = Column(Integer, nullable=True)
    t1_away_form_gs = Column(Integer, nullable=True)
    t1_away_form_gc = Column(Integer, nullable=True)
    t2_home_form_gs = Column(Integer, nullable=True)
    t2_home_form_gc = Column(Integer, nullable=True)
    t2_away_form_gs = Column(Integer, nullable=True)
    t2_away_form_gc = Column(Integer, nullable=True)
    t1_home_h2h_gs = Column(Integer, nullable=True)
    t1_home_h2h_gc = Column(Integer, nullable=True)
    t1_away_h2h_gs = Column(Integer, nullable=True)
    t1_away_h2h_gc = Column(Integer, nullable=True)
    t2_home_h2h_gs = Column(Integer, nullable=True)
...
class PredictionCreate(BaseModel):
    ...
    t1_home_form_gs: int | None = None
    t1_home_form_gc: int | None = None
    t1_away_form_gs: int | None = None
    t1_away_form_gc: int | None = None
    t2_home_form_gs: int | None = None
    t2_home_form_gc: int | None = None
    t2_away_form_gs: int | None = None
    t2_away_form_gc: int | None = None
    t1_home_h2h_gs: int | None = None
    t1_home_h2h_gc: int | None = None
    t1_away_h2h_gs: int | None = None
    t1_away_h2h_gc: int | None = None
    t2_home_h2h_gs: int | None = None
...
def insert_llm_explanation(db, fixture_id, explanation):
    ...
    if prediction:
        ...
        print(f"LLM explanation for fixture {fixture_id} updated successfully.")
    else:
