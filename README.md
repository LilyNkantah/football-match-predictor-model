...
2. **Database** — a normalised SQLite schema (Teams, Seasons, SeasonsPlayed, Fixtures, HeadToHead, Predictions) stores the processed data, accessed via SQLAlchemy.
