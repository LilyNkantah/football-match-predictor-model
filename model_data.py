...
def build_training_data(db):
    ...
    for fixture in db.query(database.Fixture).all():
        ...
        [t1_home_form_gs, t1_home_form_gc, t1_away_form_gs, t1_away_form_gc] = fixture_manipulation.calculate_goals_for_form(
            home_fixtures, fixture.home_team_id)
        [t2_home_form_gs, t2_home_form_gc, t2_away_form_gs, t2_away_form_gc] = fixture_manipulation.calculate_goals_for_form(
            away_fixtures, fixture.away_team_id)
        # goals scored/conceded across last 5 h2hs
        [t1_home_h2h_gs, t1_home_h2h_gc, t1_away_h2h_gs, t1_away_h2h_gc] = fixture_manipulation.calculate_goals_for_h2h(
            h2hs, fixture.home_team_id)
        [t2_home_h2h_gs, t2_home_h2h_gc, t2_away_h2h_gs, t2_away_h2h_gc] = fixture_manipulation.calculate_goals_for_h2h(
        ...
        rows.append((fixture.fixture_id, fixture.season_id, home_form, away_form, 
                     t1_h2h_score, t2_h2h_score, 
